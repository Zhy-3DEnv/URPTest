Shader "Framework/UI/shd_UI_AdditiveDistortionScroll_v1" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(v2f i) : COLOR {
                ...
                fixed4 emissive = (mainTexVar * i.vertexColor *(_ColorMultiplier*_TintColor * colorRampVar)*2.0*(mainTexVar.a*pow(gradientVar.r,_GradientPower)));
                float alpha = _Alpha;
                //fixed4 finalCol;
                //finalCol = emissive;
                //finalCol.a = 1;
                return fixed4(emissive.rgb * alpha, 1);
            }
            ENDHLSL
        }
    }
