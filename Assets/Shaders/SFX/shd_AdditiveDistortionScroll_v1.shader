Shader "Framework/SFX/shd_AdditiveDistortionScroll_v1" {
    Properties {
        ...
        _GradientPower ("Gradient Power", Range(0.0001, 50)) = 2.214298
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(v2f i) : COLOR {
                ...
                fixed3 emissive = (mainTexVar.rgb * i.vertexColor.rgb*(_ColorMultiplier*_TintColor.rgb * colorRampVar.rgb)*2.0*(mainTexVar.a*pow(gradientVar.r, max(0.001, _GradientPower))));
