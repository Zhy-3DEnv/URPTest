Shader "Hidden/XRenderPipeline/LutBuilderHdr" {
    HLSLINCLUDE
    #pragma multi_compile_local _ _TONEMAPPING_ACES _TONEMAPPING_NEUTRAL _TONEMAPPING_UCHIMURA
